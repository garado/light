...
from ...models.get_api_notes_response_200 import GetApiNotesResponse200
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> GetApiNotesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetApiNotesResponse200.from_dict(response.json())
