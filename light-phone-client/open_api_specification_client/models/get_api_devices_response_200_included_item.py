...
if TYPE_CHECKING:
    ...
    from ..models.get_api_devices_response_200_included_item_relationships import (
        GetApiDevicesResponse200IncludedItemRelationships,
    )


T = TypeVar("T", bound="GetApiDevicesResponse200IncludedItem")


@_attrs_define
class GetApiDevicesResponse200IncludedItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        attributes = GetApiDevicesResponse200IncludedItemAttributes.from_dict(d.pop("attributes"))
        ...
        return get_api_devices_response_200_included_item
