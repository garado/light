...
from ...models.get_api_notes_param_2_response_200 import GetApiNotesParam2Response200
...
) -> GetApiNotesParam2Response200 | None:
    if response.status_code == 200:
        response_200 = GetApiNotesParam2Response200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApiNotesParam2Response200]:
    return Response(
